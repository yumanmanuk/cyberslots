 ...
 * monogram) as single-color inline SVGs. Path outlines come from
 * simple-icons (CC0). fill="currentColor" keeps the glyph in sync with
 * the surrounding text color, so dark/light themes adapt automatically.
 */
